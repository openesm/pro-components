export declare namespace Jspreadsheet {
    export type CellValue = string | number | boolean;
    type DropdownSourceItem = string | number | {
        id: string | number;
        name: string | number;
        title?: string | number;
        image?: string;
    ...
    interface CalendarOptions {
        ...
        onchange?: ((calendarElement: HTMLInputElement, newValue: string, oldValue: string) => void) | null;
    ...
    interface CustomEditor {
         ...
         */
        closeEditor?: (cell: HTMLTableCellElement, save: boolean) => CellValue | undefined;
        /**
         ...
         */
        openEditor?: (cell: HTMLTableCellElement, el: JspreadsheetInstanceElement, empty: boolean | undefined, e: TouchEvent | undefined) => void;
        /**
         ...
         */
        updateCell?: (cell: HTMLTableCellElement, value: CellValue | undefined, force: boolean | undefined) => CellValue | undefined;
    }
    export type HorizontalAlign = 'center' | 'left' | 'right' | 'justify';
    ...
    export type Column = DropdownColumn | CalendarColumn | ColorColumn | BaseColumn;
    ...
    export type ToolbarItem = ToolbarIconItem | ToolbarSelectItem | ToolbarColorItem;
    export interface NestedHeaderCell {
        id?: string;
        colspan?: number;
        title?: string;
        align?: string;
     ...
     */
    export type SortingItem = [number, CellValue];
    export type MetaInformation = Record<string, any>;
    export interface JSpreadsheetOptions {
        ...
        contextMenu?: (instance: JspreadsheetInstance, colIndex: string | null, rowIndex: string | null, event: PointerEvent) => object[] | null;
        /**
         ...
         */
        onafterchanges?: (element: JspreadsheetInstanceElement, changes: CellChange[]) => void;
        /**
         ...
         */
        onbeforechange?: (element: JspreadsheetInstanceElement, cell: HTMLTableCellElement, colIndex: string | number, rowIndex: string | number, newValue: CellValue) => undefined | CellValue;
        /**
         ...
         */
        onbeforedeletecolumn?: (element: JspreadsheetInstanceElement, colIndex: number, numOfColumns: number) => undefined | boolean;
        /**
         ...
         */
        onbeforedeleterow?: (element: JspreadsheetInstanceElement, rowIndex: number, numOfRows: number) => undefined | boolean;
        /**
         ...
         */
        onbeforeinsertcolumn?: (element: JspreadsheetInstanceElement, colIndex: number, numOfColumns: number, insertBefore: boolean) => undefined | boolean;
        /**
         ...
         */
        onbeforeinsertrow?: (element: JspreadsheetInstanceElement, rowIndex: number, numOfRows: number, insertBefore: boolean) => undefined | boolean;
        /**
         ...
         */
        onbeforepaste?: (element: JspreadsheetInstanceElement, copiedText: string, colIndex: number | string, rowIndex: number | string) => undefined | boolean | string;
        /**
         ...
         */
        onbeforesave?: (element: JspreadsheetInstanceElement, jssInstance: JspreadsheetInstance, data: {
            row: number;
         ...
         */
        onchange?: (element: JspreadsheetInstanceElement, cell: HTMLTableCellElement, colIndex: string | number, rowIndex: string | number, newValue: CellValue, oldValue: CellValue) => void;
        /**
         ...
         */
        onchangeheader?: (element: JspreadsheetInstanceElement, colIndex: string | number, oldValue: string, newValue: string) => void;
        /**
         ...
         */
        onchangemeta?: (cellName: string | Record<string, Record<string, any>>, property: string | undefined, value: string | undefined) => void;
        /**
         ...
         */
        onchangepage?: (element: JspreadsheetInstanceElement, newPageNumber: number, oldPageNumber: number) => void;
        /**
         ...
         */
        onchangestyle?: (cellName: string | Record<string, string>, cssProperty: string | undefined, propertyValue: string | undefined) => void;
        /**
         ...
         */
        oncomments?: (element: JspreadsheetInstanceElement, newComment: string | null, oldComment: string | null, cellPosition: [number, number], colIndex: number, rowIndex: number) => void;
        /**
         ...
         */
        oncopy?: (element: JspreadsheetInstanceElement, copiedData: string[], hash: number) => void;
        /**
         ...
         */
        oncreateeditor?: (element: JspreadsheetInstanceElement, td: HTMLTableCellElement, colIndex: string, rowIndex: string, input: HTMLElement) => void;
        /**
         ...
         */
        ondeletecolumn?: (element: JspreadsheetInstanceElement, colIndex: number, numOfColumns: number, deletedCells: HTMLTableCellElement[][]) => void;
        /**
         ...
         * @param deletedCells - List of cells removed.
         */
        ondeleterow?: (element: JspreadsheetInstanceElement, rowIndex: number, numOfRows: number, deletedCells: HTMLTableCellElement[][]) => void;
        /**
         ...
         */
        oneditionend?: (element: JspreadsheetInstanceElement, td: HTMLTableCellElement, colIndex: number, rowIndex: number, editorValue: CellValue, wasSaved: boolean) => void;
        /**
         ...
         * @param rowIndex - Row index of the cell whose editor was opened.
         */
        oneditionstart?: (element: JspreadsheetInstanceElement, td: HTMLTableCellElement, colIndex: string, rowIndex: string) => void;
        /**
         ...
         */
        oninsertcolumn?: (element: JspreadsheetInstanceElement, colIndex: number, numOfColumns: number, addedCells: HTMLTableCellElement[][], insertBefore?: boolean) => void;
        /**
         ...
         */
        oninsertrow?: (element: JspreadsheetInstanceElement, rowIndex: number, numOfRows: number, addedCells: HTMLTableCellElement[][], insertBefore: boolean) => void;
        /**
         * This method is called when the method setData.
         * @param element - Root HTML element of this jss instance.
         * @param instance - Jspreadsheet instance.
         */
        onload?: (element: JspreadsheetInstanceElement, instance: JspreadsheetInstance) => void;
        /**
         ...
         */
        onmerge?: (element: JspreadsheetInstanceElement, mergeInitialCell: string, colspan: number, rowspan: number) => void;
        /**
         ...
         */
        onmovecolumn?: (element: JspreadsheetInstanceElement, oldPosition: number, newPosition: number) => void;
        /**
         ...
         */
        onmoverow?: (element: JspreadsheetInstanceElement, oldPosition: string | number, newPosition: number) => void;
        /**
         * Occurs after a paste action is performed in the javascript table.
         * @param element - Root HTML element of this jss instance.
         * @param pastedData - Data pasted to the spreadsheet.
         */
        onpaste?: (element: JspreadsheetInstanceElement, pastedData: string[][]) => void;
        /**
         ...
         */
        onredo?: (element: JspreadsheetInstanceElement, historyRecord: HistoryRecord | undefined) => void;
        /**
         ...
         */
        onresizecolumn?: (element: JspreadsheetInstanceElement, colIndex: string | number, newWidth: string | number, oldWidth: number) => void;
        /**
         ...
         */
        onresizerow?: (element: JspreadsheetInstanceElement, rowIndex: string | number, newHeight: number, oldHeight: number) => void;
        /**
         ...
         */
        onsave?: (element: JspreadsheetInstanceElement, jssInstance: JspreadsheetInstance, data: any) => void;
        /**
         ...
         */
        onsort?: (element: JspreadsheetInstanceElement, colIndex: string | number, order: 0 | 1) => void;
        /**
         ...
         */
        onundo?: (element: JspreadsheetInstanceElement, historyRecord: HistoryRecord | undefined) => void;
        ...
        updateTable?: (instance: JspreadsheetInstance, cell: HTMLTableCellElement, colIndex: number, rowIndex: number, value: CellValue, displayedValue: string, cellName: string) => void;
    ...
    export interface JspreadsheetInstance {
         ...
         */
        copy: (olnlyHighlighted?: boolean, delimiter?: string, returnData?: boolean, includeHeaders?: boolean, download?: boolean) => string;
        /**
         ...
         */
        createCell: (i: number, j: number, value: CellValue) => HTMLTableCellElement;
        /**
         ...
         */
        createNestedHeader: (nestedInformation: NestedHeaderCell[]) => HTMLTableRowElement;
        /**
         * Creates a table row.
         *
         ...
         */
        createToolbar: (toolbar?: NonNullable<JSpreadsheetOptions['toolbar']>) => void;
         ...
         */
        getComments: (cell?: string | [number, number], withAuthor?: boolean) => Record<string, string> | [string, string] | string;
        /**
         ...
         */
        getValue: (cell: [number, number] | string | HTMLTableCellElement, processedValue?: boolean) => CellValue | null;
        /**
         ...
         * @param e - Event that called this method.
         */
        openEditor: (cell: HTMLTableCellElement, empty?: boolean, e?: TouchEvent) => void;
        /**
         ...
         */
        parseValue: (i: number, j: number, value: CellValue, cell?: HTMLTableCellElement) => any;
        /**
         ...
         */
        removeMerge: (cellName: string, data?: CellValue[], keepOptions?: boolean) => void;
        /**
         * Reset all filters.
         */
        resetFilters: () => void;
         ...
         */
        selectedCell: null | [number, number, number, number] | [string, string, string, string];
         ...
         */
        setComments: (cellId: string | [number, number], comments: string, author: string) => void;
        /**
         * Set data.
         ...
         */
        setData: (data?: CellValue[][] | Record<string, CellValue>[] | string) => void;
        /**
         ...
         */
        setHeight: (row: number | HTMLTableRowElement | HTMLTableCellElement, height: number, oldHeight?: number) => void;
        /**
         ...
         */
        setMerge: (cellName?: string | [number, number], colspan?: number, rowspan?: number, ignoreHistoryAndEvents?: boolean) => null | undefined;
        /**
         ...
         */
        setStyle(o: string | HTMLTableCellElement[], k: string, v: string, force?: boolean, ignoreHistoryAndEvents?: boolean): void;
        /**
         * Change cell styles.
         ...
         * @param ignoreHistoryAndEvents - If true, this method does not save the style change in history.
         */
        setStyle(o: Record<string, string | string[]>, k?: null | undefined, v?: null | undefined, force?: boolean, ignoreHistoryAndEvents?: boolean): void;
        /**
         ...
         */
        setValue: (cell: string | HTMLTableCellElement | (string | {
            x: number;
            y: number;
            newValue?: CellValue;
            value?: CellValue;
        } | HTMLTableCellElement)[], value?: CellValue, force?: boolean) => void;
        /**
         ...
         */
        setWidth(column: number[], width: number | number[], oldWidth?: number | number[]): void;
        /**
         * Show hidden column.
         * @param colNumber - Column index.
         */
         ...
         */
        updateCell: (x: number, y: number, value: CellValue, force?: boolean) => {
            x: number;
            y: number;
            col: number;
            row: number;
         ...
         */
        updateFormula: (formula: string, referencesToUpdate: Record<string, string>) => string;
        /**
         ...
         */
        updateFormulaChain: (x: number, y: number, records: ReturnType<JspreadsheetInstance['updateCell']>[]) => void;
        /**
         ...
         */
        updateSelection: (el1: HTMLTableCellElement, el2?: HTMLTableCellElement, origin?: any) => void;
        /**
         * Select cells.
         ...
         */
        updateSelectionFromCoords: (x1: number, y1?: number, x2?: number, y2?: number, origin?: any) => void;
        updateTable: () => void;
        /**
         * Internal method.
         */
    ...
    interface JssHelpers {
         ...
         */
        getCoordsFromColumnName: (columnName: string) => [number, number | null] | undefined;
        /**
         ...
         */
        injectArray: <ItemA, ItemB>(o: ItemA[], idx: number, arr: ItemB[]) => (ItemA | ItemB)[];
        /**
         * Internal method.
         */
    ...
    export interface JSpreadsheet {
        (element: HTMLDivElement | HTMLTableElement, options?: JSpreadsheetOptions): JspreadsheetInstance;
        /**
         * Set event listeners.
         ...
         */
        createFromTable: (el: HTMLTableElement, options?: JSpreadsheetOptions) => JSpreadsheetOptions;
        /**
         ...
         */
        fromSpreadsheet: (file: string | URL, __callback: (spreadsheets: TabOptions[]) => void) => void;
        /**
         * Get the column letter(s) based on its index.
         * @param i - Column index.
         */
         ...
         */
        getIdFromColumnName: (id: string, arr?: boolean) => [number, number] | string;
        helpers: JssHelpers;
        /**
         * Inserts an array within another at the given index.
         *
